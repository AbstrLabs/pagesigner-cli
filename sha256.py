...
if __name__ == '__main__':
    ...
    for inp, out in tests.items():
        check(inp, out)
    check( [
   97, 191,  76,  39,  97, 191,  80, 215,   4, 236, 175, 225,
  128, 139,  89,  26, 225, 249,  24,  96, 136, 208, 233, 143,
  190, 122, 164, 208,  64,  41,  79, 203,   5, 167, 114,  29,
   81,  46,  77,  28,  66,  70, 147,  25,  87, 153, 109, 201,
   76, 245,   3, 127,   9, 168, 184, 208, 194, 115, 233, 100,
  172, 211, 206,  94, 183,  35, 128, 104, 136,  11, 141, 146,
   75
], bytes([
  104, 184,  19, 128, 148, 231,  54,  46,
  119,  88,   5, 128,   5,  60, 168, 101,
   68, 147, 183, 201, 201, 160, 143, 250,
  247, 159,  53,  59,  23, 241,  36, 128
]).hex())
